        ...
        if (userInput) {
            ...
            switch (userInput) {
                ...
                case 'resume':
                   ...
                   break;
case 'certifications':
    showOutput('<div style="color: rgb(255, 255, 255); text-shadow: 0 0 5px rgb(255, 0, 0), 0 0 10px rgb(255, 0, 0), 0 0 15px rgb(255, 0, 0);">Certifications:<br> - <span style="color: rgb(0, 255, 0);">CMPenAndroid</span> (Mobile Application Penetration Tester)<br> - <span style="color: rgb(0, 0, 255);">eJPTv2</span> (eLearnSecurity Junior Penetration Tester)<br> - <span style="color: rgb(255, 255, 0);">CAP</span> (Certified Application Security Professional)<br> - <span style="color: rgb(255, 0, 255);">CAPT</span> (Certified Android Penetration Tester)<br> - <span style="color: rgb(0, 255, 255);">C3SA</span> (Certified Security Solutions Architect)<br> - <span style="color: rgb(255, 165, 0);">CRTA</span> (Certified Red Team Analyst)<br> - <span style="color: rgb(255, 192, 203);">API Pentesting</span> (API Penetration Tester)</div>');
    break;
